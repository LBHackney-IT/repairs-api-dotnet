using AutoFixture;
using RepairsApi.Tests.V1.Helper;
...
namespace RepairsApi.Tests.V1.Gateways
{
    ...
    //For instruction on how to run tests please see the wiki: https://github.com/LBHackney-IT/lbh-repairs-api/wiki/Running-the-test-suite.
    [TestFixture]

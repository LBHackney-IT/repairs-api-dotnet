...
namespace RepairsApi.V2.Infrastructure.Migrations
{
    ...
    [Migration("20210309154826_AddVariationGroupsAndUsers")]
    partial class AddVariationGroupsAndUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RepairsApi.V2.Infrastructure.RateScheduleItem", b =>
                {
                    ...
                    b.Property<double?>("CodeCost")
                        .HasColumnType("double precision")
                        .HasColumnName("code_cost");
            ...
            modelBuilder.Entity("RepairsApi.V2.Infrastructure.RepairsHubUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("VariationGroupId")
                        .HasColumnType("integer")
                        .HasColumnName("variation_group_id");

                    b.HasKey("Id")
                        .HasName("pk_repairs_hub_users");

                    b.HasAlternateKey("EmailAddress")
                        .HasName("ak_repairs_hub_users_email_address");

                    b.ToTable("repairs_hub_users");
                });
            ...
            modelBuilder.Entity("RepairsApi.V2.Infrastructure.SecurityGroup", b =>
                {
                    ...
                    b.Property<double?>("RaiseLimit")
                        .HasColumnType("double precision")
                        .HasColumnName("raise_limit");

                    b.Property<string>("UserType")
                        .HasColumnType("text")
                        .HasColumnName("user_type");

                    b.Property<double?>("VaryLimit")
                        .HasColumnType("double precision")
            ...
            modelBuilder.Entity("RepairsApi.V2.Infrastructure.VariationCostGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<double>("VariationCostLimit")
                        .HasColumnType("double precision")
                        .HasColumnName("variation_cost_limit");

                    b.HasKey("Id")
                        .HasName("pk_variation_cost_groups");

                    b.ToTable("variation_cost_groups");
                });
            ...
            modelBuilder.Entity("RepairsApi.V2.Infrastructure.WorkElement", b =>
                {
                    ...
                    b.HasIndex("WorkOrderId")
                        .HasDatabaseName("ix_work_elements_work_order_id");
            ...
            modelBuilder.Entity("RepairsApi.V2.Infrastructure.JobStatusUpdate", b =>
                {
                    ...
                    b.HasOne("RepairsApi.V2.Infrastructure.WorkElement", "MoreSpecificSORCode")
                        ...
                        .HasConstraintName("fk_job_status_updates_work_elements_more_specific_sor_code_id");
            ...
            modelBuilder.Entity("RepairsApi.V2.Infrastructure.RateScheduleItem", b =>
                {
                    b.HasOne("RepairsApi.V2.Infrastructure.WorkElement", null)
                        ...
                        .HasConstraintName("fk_rate_schedule_item_work_elements_work_element_id");

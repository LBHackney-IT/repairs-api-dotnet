...
namespace RepairsApi.V2.Factories
{
    public static class ResponseFactory
    {
        ...
        public static TenureViewModel ToResponse(this TenureInformation domain)
        {
            ...
            {
                TypeCode = domain.TypeCode, TypeDescription = domain.TypeDescription, CanRaiseRepair = domain.CanRaiseRepair
            };
        }
        ...
        public static Trade ToResponse(this Infrastructure.Trade trade)
        {
            return new Trade
            {
                Code = trade.Code.Value, CustomCode = trade.CustomCode, CustomName = trade.CustomName
            };
        }
